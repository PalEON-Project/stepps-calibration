...
runs = [ ('cal_pl_vary_kernel_EPs_v0.3',
          './calibration_pl_vary_kernel_EPs.exe \
          sample num_warmup=250 num_samples=500 save_warmup=1\
          data file=../r/dump/cal_data_12taxa_mid_comp_v0.1.dump \
          output file=../output/12taxa_mid_comp_pl_vary_kernel_EPs_v0.3.csv\
          random seed=42'),
         ('cal_pl_vary_kernel_gamma_EPs_v0.3',
          './calibration_pl_vary_kernel_gamma_EPs.exe \
          sample num_warmup=250 num_samples=500 save_warmup=1\
          data file=../r/dump/cal_data_12taxa_mid_comp_v0.1.dump \
          output file=../output/12taxa_mid_comp_pl_vary_kernel_gamma_EPs_v0.3.csv\
          random seed=42')
]
