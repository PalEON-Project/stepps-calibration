...
namespace calibration_bigC_model_namespace {
...
class calibration_bigC_model : public prob_grad {
private:
    int K;
    int N_cores;
    int N_cells;
    ...
    matrix_d d_pot;
public:
    calibration_bigC_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad::prob_grad(0) {
        static const char* function__ = "calibration_bigC_model_namespace::calibration_bigC_model(%1%)";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        // model body
        {
            ...
            for (int v = 1; v <= N_pot; ++v) {
                stan::math::assign(C, (C + (get_base1(d_pot,v,2,"d_pot",1) * exp((-(square(get_base1(d_pot,v,1,"d_pot",1))) / square(psi))))));
            }
            ...
            for (int i = 1; i <= N_cores; ++i) {
                ...
                stan::math::assign(get_base1_lhs(r_new,i,"r_new",1), add(get_base1(r_new,i,"r_new",1),divide(multiply(out_sum,(1 - gamma)),C)));
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "calibration_bigC_model_namespace::write_array(%1%)";
        (void) function__; // dummy call to supress warning
    ...
    void write_csv(RNG& base_rng__,
        ...
        stan::io::reader<double> in__(params_r__,params_i__);
        stan::io::csv_writer writer__(o__);
        static const char* function__ = "calibration_bigC_model_namespace::write_csv(%1%)";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        vector_d phi = in__.vector_lub_constrain(0.01,300,K);
        writer__.write(phi);
...
int main(int argc, const char* argv[]) {
    try {
        return stan::gm::command<calibration_bigC_model_namespace::calibration_bigC_model>(argc,argv);
